    ...
    function sendPasswordResetMail($email, $name, $token){
         sendMail($email, $name, "Changement de mot de passe Wavope.", '<link rel="preconnect" href="https://fonts.googleapis.com">
             ...
             <center style="
                 ...
                 <a href="https://www.wavope.fr/resetpassword?r=r&token='. $token .'" style="
                        padding: 12px 20px;
                        margin: 15px 15px;
                        border-radius: 25px;
                 ...
                 <br/>
                 <br/>
                 <p style="font-size: 0.75rem;">Cette demande ne vient pas de vous ? <a href="https://www.wavope.fr/resetpassword?r=c&token='. $token .'">Cliquez ici</a><br/></p><br/>
                 <br/>
                 <br/>
                 <img src="https://i.imgur.com/C5sVWQi.png" />
                 </center>', 'Vous avez demandé à changer de mot de passe. Allez à l\'adresse https://www.wavope.fr/resetpassword?r=r&token='. $token .' pour poursuivre.
             \n Si ce n\'est pas vous, allez à l\'adresse https://www.wavope.fr/resetpassword?r=c&token='. $token);
    }
?>
