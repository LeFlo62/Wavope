    ...
    function sendCreationMail($email, $name){
        sendMail($email,
                ...
                <center style="font-family: "Roboto", sans-serif;
                    ...
                    <a href="https://www.wavope.fr/resetpassword?r=f" style="
                            padding: 12px 20px;
                            margin: 15px 15px;
                            border-radius: 25px;
                    ...
                    <img src="https://i.imgur.com/C5sVWQi.png" />
                     ...
                     'Vous avez demandé à changer de mot de passe. Allez à l\'adresse https://www.wavope.fr/resetpassword?r=f pour poursuivre.');
   }
?>