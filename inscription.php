...
<body>
    ...
    <div class="block">
        ...
        <p id="ErrorMdp">Les mots de passes ne correspondent pas !</p>
        <p id="ChampIncomplet">Tous les champs obligatoires ne sont pas renseigné</p>
...
<!--        </form>-->
            ...
            <form method="post" action="traitementInscription.php"  class="InscriptionForm">
            <label class="fieldInput">E-mail*<input type="email" name="nameUtilisateur" id="nameUtilisateur" placeholder=" exemple.mail@gmail.fr"/></label>
